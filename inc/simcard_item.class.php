   ...
   static function showForSimcard(PluginSimcardSimcard $simcard) {
      ...
      if (PluginSimcardsimcard::canUpdate()) {
         ...
         if (empty($results)) {
            ...
            Dropdown::showSelectItemFromItemtypes(["entity_restrict" => $simcard->fields['entities_id'], "itemtypes" => self::getClasses()]);
            // DEPRECATED :: Dropdown::showAllItems("items_id",0,0,$simcard->fields['entities_id'], self::getClasses());
            echo "</td>";
